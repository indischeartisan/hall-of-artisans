    ...
    <div className="prep-layout">
      <section className="prep-panel prep-creation">
        ...
        {described ? <div className="prep-story">
          {snapshot?.ambienceImage?.dataUrl && <section className="prep-ambience-reference"><h3>Ambience Reference</h3><img src={snapshot.ambienceImage.dataUrl} alt="Customer ambience reference"/><small>{snapshot.ambienceImage.fileName}</small></section>}
