    ...
    <main><section className="register-page-shell register-only-shell" id="create-artisan-id" aria-labelledby="registerTitle">
      ...
      <div className="register-layout">
        ...
        <form className="register-form ornate-panel bright-register-panel" id="artisanRegisterForm" autoComplete="off" noValidate onSubmit={submit}>
          ...
          <p className={`form-message${pendingEmail ? " verification-message" : ""}`} role="status" aria-live="polite">{message}</p>
          {pendingEmail && <button className="form-existing-artisan verification-resend" type="button" disabled={resending} onClick={async () => {
            setResending(true);
