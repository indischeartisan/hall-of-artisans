...
export default function GlobalHeader({ action, activeLabel, variant = "default" }: GlobalHeaderProps) {
  ...
  const loadNotifications = useCallback(async () => {
    ...
    finally { setNotificationsRefreshing(false); }
  }, [user?.id]);
  ...
  const isHallRoute = currentPath === "/hall" || currentPath.startsWith("/hall/");
  ...
  return (
    ...
    <header className={headerClasses} id="siteHeader">
      <a className="brand" href="/hall" aria-label="The Hall of Artisans home" onClick={(event) => navigateWithTransition(event, "/hall")}>
      ...
      {isHallRoute && <a className="hall-main-site-link" href="/" onClick={(event) => navigateWithTransition(event, "/")}>Indische Artisan <span aria-hidden="true">↗</span></a>}
      ...
      <nav className={`main-nav${menuOpen ? " open" : ""}`} id="mainNav" aria-label="Main navigation">
        ...
        <div className="mobile-nav-tools" aria-label="Account and appearance" ref={mobileAccountRef}>
          {accountEmail && (
            <>
              <button className="mobile-nav-account-item mobile-nav-notifications mobile-nav-notifications-primary" type="button" onClick={toggleNotifications}>
              ...
              {notificationsOpen && (
                <div className="mobile-nav-notification-list mobile-nav-notification-list-primary">
                  <button type="button" disabled={notificationsRefreshing} onClick={() => void loadNotifications()}>{notificationsRefreshing ? "Refreshing…" : "Refresh Notifications"}</button>
                  <header>
          ...
          {accountOpen && (
            <div className="mobile-nav-account-menu" id="mobileAccountMenu">
              {accountEmail ? (
                <>
                  <a className="mobile-nav-account-item" href="/hall/artisan-id" onClick={(event) => navigateWithTransition(event, "/hall/artisan-id")}><i aria-hidden="true">ID</i><span><strong>My Artisan ID</strong><small>View your identity card</small></span></a>
